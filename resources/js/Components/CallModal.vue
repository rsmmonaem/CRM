                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-lg p-4 border border-green-200 dark:border-green-600">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <a
                                        v-if="!isCallActive && props.lead?.phone"
                                        :href="`https://wa.me/88${props.lead.phone.replace(/\D/g, '')}`"
                                        target="_blank"
                                        class="flex-1 bg-[#25D366] hover:bg-[#128C7E] text-white font-semibold py-2 px-4 rounded-lg text-sm transition-all duration-200 flex items-center justify-center space-x-2"
                                    >
                            ...
                            <form @submit.prevent="submitCall" class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div v-if="form.errors.call_status" class="mt-1 text-sm text-red-600 dark:text-red-400">
